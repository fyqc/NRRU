...
![右键我的电脑](IMG/m3o4zv3o.bmp)

> 右键我的电脑

![Alt text](IMG/25xjbwjy.bmp)

![右键空白处，点击“新用户”](IMG/ot5u8k9e.bmp)

> 右键空白处，点击“新用户”

新建了一个账号为 "joker" 的用户，相关设置如下：

![由于只是用于共享，因此可以设置不能更改密码，且密码不会过期](IMG/hjr0vqge.bmp)
...
![微软也明确说明了，开启此项功能会产生很大的安全漏洞](IMG/6c0dwrwj.bmp)
...
![Alt text](IMG/8977tbno.bmp)

![Alt text](IMG/cnrnt2xl.bmp)

![Alt text](IMG/4lodw3s3.bmp)

![Alt text](IMG/50fgmwzj.bmp)
...
![Alt text](IMG/t8azxjg7.bmp)

![Alt text](IMG/ihapzltj.bmp)
...
![Alt text](IMG/47n5ia0m.bmp)

![文件夹里面有一张图片文件夹里面有一张图片](IMG/a359z450.bmp)

> 文件夹里面有一张图片文件夹里面有一张图片

![右键文件夹，点击“属性”](IMG/98zzmh1n.bmp)

> 右键文件夹，点击“属性”

![点击“高级共享”](IMG/4xq45uqn.bmp)

> 点击“高级共享”

![Alt text](IMG/td8gjs9j.bmp)

![删除 Everyone 用户，不然谁都可以进行访问就不好了](IMG/33fsaazy.bmp)

> 删除 Everyone 用户，不然谁都可以进行访问就不好了

![Alt text](IMG/m0h99zxj.bmp)

![Alt text](IMG/04kam2ed.bmp)

![Alt text](IMG/wtwqw5qh.bmp)

![Alt text](IMG/dh4qx07j.bmp)
...
![Alt text](IMG/g1za4gts.bmp)

![注意，这里的地址我们不要用主机名的形式，而应该用ip地址](IMG/o302wh69.bmp)

> 注意，这里的地址我们不要用主机名的形式，而应该用ip地址
...
![Alt text](IMG/cwan0r0m.bmp)

![Alt text](IMG/8q0dag4v.bmp)
